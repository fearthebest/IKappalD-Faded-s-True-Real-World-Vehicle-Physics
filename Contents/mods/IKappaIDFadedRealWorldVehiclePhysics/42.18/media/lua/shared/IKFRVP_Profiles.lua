...
-- HP raised from initial 1.0 release (~7%) plus ~3% for v1.0.2; engineForce = hp * 10.65 (v1.0.3, recomputed each resolve).
Profiles.definitions = {
    Compact = { hp = 85, mass = 955, class = "compact" },
    CompactSport = { hp = 160, mass = 1325, class = "sport" },
    Sedan = { hp = 187, mass = 1760, class = "standard" },
    ModernSedan = { hp = 138, mass = 1305, class = "standard" },
    Wagon = { hp = 182, mass = 1950, class = "standard" },
    Luxury = { hp = 248, mass = 1855, class = "sport" },
    Sport = { hp = 293, mass = 1485, class = "sport" },
    Race = { hp = 403, mass = 1540, class = "sport" },
    Offroad = { hp = 199, mass = 1515, class = "heavy" },
    Pickup = { hp = 182, mass = 2240, class = "heavy" },
    CrewPickup = { hp = 176, mass = 2355, class = "heavy" },
    SUV = { hp = 187, mass = 2225, class = "heavy" },
    Van = { hp = 127, mass = 2310, class = "heavy" },
    StepVan = { hp = 130, mass = 3260, class = "heavy" },
...
function Profiles.getProfile(profileId)
    ...
    if profile.hp then
        profile.engineForce = math.floor(profile.hp * 10.65 + 0.5)
    end
    return profile
end
