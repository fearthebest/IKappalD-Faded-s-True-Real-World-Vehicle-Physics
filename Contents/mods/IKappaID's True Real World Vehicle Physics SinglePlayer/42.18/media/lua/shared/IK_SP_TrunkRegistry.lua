...
IK_SP.TrunkRegistry = IK_SP.TrunkRegistry or {}
...
function R.matchesModTrunkProfile(typ, partId, part, ltyp)
    ...
    if part and part.isSeat and part:isSeat() and part.getItemContainer and part:getItemContainer() then
        return true
    end
    if partId ~= "" and string.find(partId, "seat", 1, true) and part and part.getItemContainer and part:getItemContainer() then
        return true
    end
