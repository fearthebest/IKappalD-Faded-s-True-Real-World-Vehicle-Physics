...
IK_SP.Profiles = IK_SP.Profiles or {}

local Profiles = IK_SP.Profiles
...
if not IK_SP_KI5_Roster then
    require "IK_SP_Profiles_KI5"
end
mergeRoster(IK_SP_KI5_Roster)

if not IK_SP_ATA_Roster then
    require "IK_SP_Profiles_ATA"
end
mergeRoster(IK_SP_ATA_Roster)

if not IK_SP_Autotsar_Roster then
    require "IK_SP_Profiles_Autotsar"
end
mergeRoster(IK_SP_Autotsar_Roster)

if not IK_SP_FHQ_Roster then
    require "IK_SP_Profiles_FHQ"
end
mergeRoster(IK_SP_FHQ_Roster)

if not IK_SP_Misc_Roster then
    require "IK_SP_Profiles_Misc"
end
mergeRoster(IK_SP_Misc_Roster)

if not IK_SP_rSemiTruck_Roster then
    require "IK_SP_Profiles_rSemiTruck"
end
mergeRoster(IK_SP_rSemiTruck_Roster)
