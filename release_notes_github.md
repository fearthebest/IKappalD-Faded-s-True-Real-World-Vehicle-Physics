...
This release ships **B42 common/media/** required on Build **42.18+**. Download the release zip, then copy **Contents/mods/IKappaIDFadedRealWorldVehiclePhysics/** into **Zomboid/mods/** (must include **common/** and **42.18/**). 
 
Full steps: **docs/INSTALL.md** in the repo.
